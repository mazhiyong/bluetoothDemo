...
public class PrintUtiTest {
     ...
     * @throws IOException
     */
    public PrintUtiTest(OutputStream outputStream, String encoding) throws IOException {
    ...
    public void printOneText(String text) throws IOException {
...
//            pUtil.printLine(4);
  ...
  /*  public static void printReceipt (BluetoothSocket bluetoothSocket, OrderDetailsBean bean, String msgId) {
        OrderDetailsBean.OrderBean order = bean.getOrderBean();
        List<OrderDetailsBean.OrderBean.GoodsList> goodList  = bean.getOrderBean().getGoodsList();

        try {
            PrintUtil pUtil = new PrintUtil(bluetoothSocket.getOutputStream(), "GBK");
            pUtil.printLine();
            pUtil.printAlignment(1);
            pUtil.printLargeText(String.valueOf(System.currentTimeMillis()));
            pUtil.printLine();
            ...
            pUtil.printAlignment(1);
            pUtil.printOneText("#"+msgId+"众聚逛选");
            pUtil.printLine();


            pUtil.printAlignment(1);
            pUtil.printOneText(order.getShopname());
            pUtil.printLine();
            ...
            pUtil.printAlignment(1);
            pUtil.printOneText("订单号："+order.getOrderno());
            pUtil.printLine();

            pUtil.printAlignment(1);
            pUtil.printOneText("下单时间："+order.getOrderAdtime());
            pUtil.printLine();
            ...
            for (int i = 0; i < goodList.size(); i++) {
                pUtil.printAlignment(0);
                pUtil.printOneText( goodList.get(i).getGoodsname());
                pUtil.printLine();

                pUtil.printThreeColumn( goodList.get(i).getValue1(),
                        "x"+goodList.get(i).getNum(),
            ...
            pUtil.printAlignment(0);
            pUtil.printOneText("配送费：¥"+order.getDisCusFee());
            pUtil.printLine();

            pUtil.printAlignment(0);
            pUtil.printOneText("店铺优惠：-¥"+order.getCashprice());
            pUtil.printLine();

            pUtil.printTwoColumn("合计：", "¥"+order.getAccount());
            pUtil.printLine();
            ...
            pUtil.printAlignment(0);
            pUtil.printOneText(order.getReceaddr());
            pUtil.printLine();


            pUtil.printAlignment(0);
            pUtil.printOneText(order.getRecename());
            pUtil.printLine();


            pUtil.printAlignment(0);
            pUtil.printOneText(order.getPhoneNum());
            pUtil.printLine();
